...
RSpec.describe 'Category', type: :request do
  ...
  let(:user) { User.create(name: 'Eyasu Teshome', email: 'new@mail.com', password: 'password') }
  ...
  let(:expense_category) { CategoryExpense.create(category_id: category.id, expense_id: expense.id) }
